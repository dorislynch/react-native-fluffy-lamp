...
@interface RNFluffyLampHelper () <RCTTurboModuleManagerDelegate> {
...
@interface RNFluffyLampHelper () <RCTCxxBridgeDelegate> {
...
@implementation RNFluffyLampHelper

static RNFluffyLampHelper *instance = nil;
